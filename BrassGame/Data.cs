...
public static class Data
{
    ...
    public static readonly LocDef[] Locations =
    {
        ...
        new("Birmingham", 1258, 1461, new[]{ S(1215,1305,Cot,Man), S(1304,1305,Man), S(1215,1400,Ir), S(1304,1400,Man) }),
        new("Coventry", 1621, 1520, new[]{ S(1619,1365,Pot), S(1573,1460,Man,Co), S(1661,1460,Ir,Man) }),
